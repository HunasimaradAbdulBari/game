// src/app/QuestGame/page.tsx - COMPLETE
'use client';
...
export default function MenuPage() {
  ...
  const [currentScene, setCurrentScene] = useState<'subject' | 'level'>('subject');
    ...
    <Layout scene="menu">
      ...
      >
        ...
        <div className="title-section" style={{ 
          ...
          <h1
            style={{
              fontSize: 'clamp(22px, 5.5vh, 38px)',
              fontWeight: '800',
              color: '#1e293b',
              margin: '0',
          ...
          <h2
            style={{
              fontSize: 'clamp(13px, 2.8vh, 18px)',
              fontWeight: '600',
              color: '#475569',
              margin: '0',
            }}
